...
class FactsCalculatorOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        #
        records = redshift_hook.get_records(facts_sql_template.format(self.destination_table,self.destination_table,self.groupby_column,self.fact_column,self.fact_column,self.fact_column,self.fact_column,self.fact_column,self.fact_column,self.origin_table,groupby_column)
